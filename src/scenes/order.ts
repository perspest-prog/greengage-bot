...
order.action("link-help", async (ctx) => {
    await ctx.replyWithVideo("BAACAgIAAxkBAAMKaD29FeG5o5V9W2T39Fz7BPUkfdAAAtRrAALB31FK9n2etoloU_I2BA")
...
order.action("size-help", async (ctx) => {
    await ctx.replyWithVideo("BAACAgIAAxkBAAMLaD29SvKHUNC3BMlGZntwigt3VHMAAmxoAAJa50FK4NSyHA1Fr1g2BA")
